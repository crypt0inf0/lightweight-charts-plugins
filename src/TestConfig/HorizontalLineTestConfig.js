// /src/TestConfig/HorizontalLineTestConfig.js
...
// --- Import base tool data for default options and specific test values ---
import { defaultHorizontalLineOptions } from '../Data/HorizontalLineToolData';

// ----------------------------------------------------------------------
// 1. BASELINE DEFAULTS FOR HORIZONTAL LINE
// ----------------------------------------------------------------------
// The master defaults for all single-override tests.
export const HorizontalLineOptionDefaults = deepCopy(defaultHorizontalLineOptions);
 ...
 * within the HorizontalLine tool's full options structure.
 */
export const HorizontalLineUniversalTestConfig = {
	...
	// --- II. HorizontalLine Specific Options ---
	...
	line: {
		...
		// The 'extend' property is the main differentiating feature from a standard line:
		// Test user's ability to override the default full-span extension
		extend: {
			left: [false],
			right: [false],
		},

		testInfiniteLine: [false],
	},
...
export const HorizontalLineContextualOverrides = {
	...
	'notEditableCursor': {
        ...
        text: {
            value: 'LINE.EXTEND.LEFT=FALSE & RIGHT=FALSE (NO Infinite Line)',
        },
    },
	'showPriceAxisLabels': {
