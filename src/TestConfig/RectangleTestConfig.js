// File: /src/TestConfig/RectangleTestConfig.js
...
import { defaultRectangleOptions } from '../Data/RectangleToolData';

/**
 * The primary set of default options for the Rectangle Tool, used as the base
 * for every single test case generated.
 */
export const RectangleOptionDefaults = defaultRectangleOptions;

// --- Constants used in Test Generation Logic ---
// These are placeholders for now, but will be needed once text tests are flushed out
 ...
 * within the Rectangle tool's full options structure.
 */
export const RectangleUniversalTestConfig = {
    ...
    // B. Text Properties (Initial Flush Out)
    text: {
