// /src/TestConfig/VerticalLineTestConfig.js

import { LineStyle } from 'lightweight-charts';
import {
	PaneCursorType, TextAlignment, BoxVerticalAlignment, BoxHorizontalAlignment, LineEnd, deepCopy
} from 'lightweight-charts-line-tools-core';

// --- Import data specific to the VerticalLine tool ---
import { defaultVerticalLineOptions } from '../Data/VerticalLineToolData';

// ----------------------------------------------------------------------
// 1. BASELINE DEFAULTS FOR VERTICAL LINE
// ----------------------------------------------------------------------
// The master defaults for all single-override tests.
export const VerticalLineOptionDefaults = deepCopy(defaultVerticalLineOptions);
...
 * within the VerticalLine tool's full options structure.
 */
export const VerticalLineUniversalTestConfig = {
	...
	defaultAnchorHoverCursor: [PaneCursorType.VerticalResize], // Vertical resize for testing parity
	defaultAnchorDragCursor: [PaneCursorType.VerticalResize], // Vertical resize for testing parity
	notEditableCursor: [PaneCursorType.Pointer],

	// Label Visibility / Persistence Testing 
	showTimeAxisLabels: [false], // Test overriding the default hide
	timeAxisLabelAlwaysVisible: [false], // Test overriding the default show


	// --- II. VerticalLine Specific Options ---
	...
	line: {
		...
		// End points (for top/bottom of the vertical line)
		end: {
...
export const VerticalLineContextualOverrides = {
