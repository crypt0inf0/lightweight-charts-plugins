// /src/TestConfig/RayTestConfig.js
...
import { TrendLineOptionDefaults } from './TrendLineTestConfig'; // Assumes TrendLineTestConfig.js exports this


// ----------------------------------------------------------------------
// 1. BASELINE DEFAULTS FOR RAY
// ----------------------------------------------------------------------

// We start with a copy of TrendLineOptionDefaults and apply the one defining change: right extension.
export const RayOptionDefaults = deepCopy(TrendLineOptionDefaults);
RayOptionDefaults.line = {
    ...RayOptionDefaults.line,
    extend: { left: false, right: true }, // Set the defining property for Ray
    color: 'rgba(255, 255, 0, 1)', // Set a distinct default color for easy visual identification (Yellow)
};
 ...
 * within the Ray tool's full options structure.
 */
export const RayUniversalTestConfig = {
	...
	line: {
		...
		// BOOLEAN TEST: Allow user to test turning OFF the right extension OR turning ON the left extension
		extend: {
			left: [true], // Test turning ON left extension (making it an extended line)
			right: [false], // Test turning OFF right extension (making it a finite segment)
		},
...
export const RayContextualOverrides = {
