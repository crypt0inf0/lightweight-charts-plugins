...
This package provides a specialized **Long/Short Position** tool for the [Lightweight Charts v5+](https://github.com/tradingview/lightweight-charts) plugin system. It is a critical risk management utility that visualizes entry, stop-loss, and profit-target levels, automatically calculating Risk:Reward ratios in real-time. It is part of a modular, high-performance **drop-in replacement** suite for the legacy [v3.8 Line Tools Build](https://github.com/difurious/lightweight-charts-line-tools).
