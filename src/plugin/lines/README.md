# Lightweight Charts Standard Line Tools
...
1.  **Clone the repository**:
    ```bash
    git clone https://github.com/difurious/lightweight-charts-line-tools-lines.git
    cd lightweight-charts-line-tools-lines
    ```
...
4.  **Output**:
    ...
    *   `/docs`: Technical API documentation. Open `docs/index.html` and navigate to classes like `LineToolTrendLine`, `LineToolRay`, or `LineToolCallout` to view all available configuration options (line styles, end caps, extensions) and methods.
...
Here is how to register and use the standard line tools in your chart.
...
// 2. Register all 9 tools available in this package
...
// 3. Use any of the registered keys to start drawing
